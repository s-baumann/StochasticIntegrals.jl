...
export ItoIntegral, get_volatility, get_variance, get_covariance, get_correlation, ItoSet, ForwardCovariance
...
export ItoProcess, evolve, evolve_covar_and_ito_processes, make_ito_process_non_syncronous_time_series
